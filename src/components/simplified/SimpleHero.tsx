    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center pt-20">
      ...
      <div className="container mx-auto px-4 z-10 flex flex-col md:flex-row items-center justify-between">
        <div className="md:w-1/2 text-center md:text-left mb-10 md:mb-0">
          <h1 className="text-4xl md:text-6xl font-serif font-bold mb-4 text-amber-700 dark:text-amber-500">
            <span className="block">Abrar –</span>
            <span className="block mt-2">Elite College Prep Coach</span>
          </h1>
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-4">
            <button 
              ...
              className="px-8 py-3 rounded-full bg-amber-600 hover:bg-amber-500 text-white font-bold shadow-lg"
            >
              Book Free Consult
            </button>
            ...
            <button 
              ...
              className="px-8 py-3 rounded-full bg-white dark:bg-gray-800 text-amber-600 dark:text-amber-400 font-bold shadow-lg"
            >
              Learn More
            </button>
          </div>
        ...
        <div className="md:w-1/2 flex justify-center md:justify-end">
          <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-amber-500 shadow-xl">
            <img 
