...
const InteractiveWaveform = () => {
    ...
    return (_jsx("div", { className: "fixed inset-0 pointer-events-none z-0 overflow-hidden", children: _jsxs("svg", { ref: svgRef, className: "w-full h-full opacity-40 dark:opacity-30", onMouseMove: handleMouseMove, onMouseEnter: () => setIsHovering(true), onMouseLeave: () => setIsHovering(false), style: { pointerEvents: 'auto' }, children: [_jsx("defs", { children: _jsxs("linearGradient", { id: "waveGradient", x1: "0%", y1: "0%", x2: "100%", y2: "0%", children: [_jsx("stop", { offset: "0%", stopColor: "rgba(217, 119, 6, 0.2)" }), _jsx("stop", { offset: "50%", stopColor: "rgba(217, 119, 6, 0.4)" }), _jsx("stop", { offset: "100%", stopColor: "rgba(217, 119, 6, 0.2)" })] }) }), _jsx("path", { d: generateWavePath(), fill: "none", stroke: "url(#waveGradient)", strokeWidth: "2", strokeLinecap: "round", className: "transition-all duration-300 ease-in-out" }), _jsx("path", { d: generateWavePath(), fill: "none", stroke: "url(#waveGradient)", strokeWidth: "1", strokeLinecap: "round", strokeDasharray: "5,5", className: "transition-all duration-300 ease-in-out", transform: `translate(0, ${dimensions.height * 0.4}) scale(1, -0.7)` })] }) }));
};
