...
const FAQ = () => {
    ...
    return (_jsx("section", { id: "FAQ", className: "py-16 bg-gray-50 dark:bg-gray-800", children: _jsxs("div", { className: "container mx-auto px-4", children: [_jsx("h2", { className: "text-4xl font-serif font-bold text-center mb-12 dark:text-white", children: "Frequently Asked Questions" }), _jsx("div", { className: "max-w-3xl mx-auto", children: faqItems.map((item, index) => (_jsxs("div", { className: "mb-4", children: [_jsxs("button", { onClick: () => toggleItem(index), className: "flex justify-between items-center w-full p-5 bg-white dark:bg-gray-900 rounded-lg shadow-md hover:shadow-lg transition-all focus:outline-none", children: [_jsx("span", { className: "text-lg font-medium text-left dark:text-white", children: item.question }), _jsx("svg", { className: `w-5 h-5 text-gray-500 transform transition-transform ${openItem === index ? 'rotate-180' : ''}`, fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M19 9l-7 7-7-7" }) })] }), openItem === index && (_jsx("div", { className: "mt-2 p-5 bg-white dark:bg-gray-900 rounded-lg shadow-md", children: _jsx("p", { className: "text-gray-700 dark:text-gray-300", children: item.answer }) }))] }, index))) })] }) }));
};
export default FAQ;
